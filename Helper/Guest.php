...
namespace AHT\OrderPassword\Helper;
...
class Guest extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        $password = $postData['oar_billing_password'];
         
        $billingAddress = $order->getBillingAddress();
        $id = $order->getQuoteId();
        $quote = $this->quoteRepository->get($id);
        $password_en = $quote->getPassword();
        $password_de = $this->encryptor->decrypt($password_en); 
        return $password_de === $password;
    }
